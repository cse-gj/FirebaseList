...
import com.sample.firebaselist.model.UserModel;
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                FirebaseStorage.getInstance().getReference().child("userImages").child(uid).putFile(imageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                                        ...
                                        userModel.uid = FirebaseAuth.getInstance().getCurrentUser().getUid(); //uid가 담겨서 회원가입이 됩니다.

                                        FirebaseDatabase.getInstance().getReference().child("profile").child(uid).setValue(userModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
